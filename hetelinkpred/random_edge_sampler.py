...
def find_exclude_eids(g, seed_edges, exclude, reverse_eids=None, reverse_etypes=None,
    ...
    # print(degree_mask)
    # randomly shuffle the degree mask
    indexes = torch.randperm(degree_mask.shape[0])
    degree_mask = degree_mask[indexes]
    # print(degree_mask)
...
class EdgePredictionSamplerwithRandom(EdgePredictionSampler):
